...
public class DotsandBoxesNewMap : MonoBehaviour
{
    ...
    GameObject[] horizontal_object = new GameObject[45];
    int[] horizontal_value = new int[45];
    GameObject[] vertical_object = new GameObject[48];
    int[] vertical_value = new int[48];
    GameObject[] boxes = new GameObject[40];
    GameObject[,] all_game = new GameObject[40, 5];
    int[,] all_gamer_value = new int[40, 5];
    ...
    void Start()
    {
        ...
        string name1 = "Horizontal_Line";
        string name2 = "Verticle_Line";
        string name3 = "Box";
        for (int i = 0; i < 45; i++)
        {
            string temp = name1 + " (" + i + ")";
        ...
        for (int i = 0; i < 40; i++)
        {
            ...
            all_game[i, 1] = horizontal_object[i + 5];
            all_game[i, 2] = vertical_object[t2 * 6 + t1];
            all_game[i, 3] = vertical_object[t2 * 6 + t1 + 1];
        }
        ...
        settings = PlayerPrefs.GetInt("Dotsandboxesnew", 0);
