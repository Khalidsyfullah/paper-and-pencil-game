...
public class Fourinarow_small : MonoBehaviour
{
    ...
    GameObject[,] grid_cell = new GameObject[7, 5];
    int[,] grid_board = new int[7, 5];
    Vector2Int[] emptyCells = new Vector2Int[5];
    ...
    void Start()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            emptyCells[i] = new Vector2Int(6, i);
            SpriteRenderer spriteRenderer = grid_cell[6, i].GetComponent<SpriteRenderer>();
            spriteRenderer.sprite = possible_move;
        }


        settings = PlayerPrefs.GetInt("fourinarowsmall", 0);
