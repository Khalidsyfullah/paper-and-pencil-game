...
public class Dotsandboxes_small : MonoBehaviour
{
    ...
    GameObject[] horizontal_object = new GameObject[35];
    int[] horizontal_value = new int[36];
    GameObject[] vertical_object = new GameObject[36];
    int[] vertical_value = new int[36];
    GameObject[] boxes = new GameObject[30];
    GameObject[,] all_game = new GameObject[30, 5];
    int[,] all_gamer_value = new int[30, 5];
    ...
    void Start()
    {
        ...
        settings = PlayerPrefs.GetInt("DotsandBoxessmall", 0);
