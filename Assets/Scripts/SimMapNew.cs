...
public class SimMapNew : MonoBehaviour
{
    int sound = 1, vibration = 1, soundSettings = 1;
    public AudioSource audioSource;
    public AudioClip audioClip1, audioClip2, audioClip3, audioClip4, audioClip5;

    int[,] grid_num = new int[13, 3];
    GameObject[,] grid_value = new GameObject[13, 3];
    Color[] df_val = { Color.blue, Color.red };
    int current_player = 0;
    int settings = 0;
    public GameObject parentObject;
    public GameObject prt;
    int[,] triangles = new int[13, 3] {{6, 0, 5},{5, 3, 4},{4, 10, 11},{11, 12, 17},{12, 18, 20},{20, 21, 19},{19, 22, 13},{13, 15, 14},{14, 17, 8},{15, 16, 9},{9, 2, 23},{23, 8, 7},{7, 6, 1}};
    ...
    void Start()
    {
        ...
        settings = PlayerPrefs.GetInt("simpageNew", 0);
